...
**Related:** [CASES.md](CASES.md), [DISPATCH.md](DISPATCH.md), [REFERRALS.md](REFERRALS.md), [FOLLOWUP.md](FOLLOWUP.md), [AUTH.md](AUTH.md), [CONSENT.md](CONSENT.md)
...
| `CONTACT_ATTEMPT` | Logs an attempt (channel, time, outcome pending) | Active assignment |
| `CONTACT_COMPLETE` | Logs completion of a contact (outcome) | Prior or simultaneous attempt; emit `RESPONDER_CONTACT_LOGGED` |
| `ADD_NOTE` | Creates CaseNote | Active assignment (or org-admin read/write policy) |
